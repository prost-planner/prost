...
void StringUtils::replace(std::string& s, std::string& searchFor, std::string& replaceBy) {
...
void StringUtils::embraceSubstringWithWhitespaces(std::string& s, std::string substr) {
...
void StringUtils::deleteCommentFromLine(std::string& line, std::string commentSign) {
    size_t index;
...
void StringUtils::nextParamValuePair(std::string& desc, std::string& param, std::string& value) {
    std::stringstream tmp;
