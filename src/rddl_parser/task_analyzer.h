...
protected:
    ...
    void analyzeStateAndApplyAction(State const& current, State& next,
            double& reward) const;
    void applyRandomApplicableAction(State const& current, State& next,
            double& reward) const;
    void applyRandomApplicableAction(std::vector<int> const& applicableActions,
            State const& current, State& next,
            double& reward) const;
