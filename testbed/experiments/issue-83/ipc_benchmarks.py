...
benchmark_dir = os.environ["PROST_BENCHMARKS"]

ACADEMIC_ADVISING_2014 = [
    Problem("academic-advising-2014", inst, -200.0,
            benchmarks_dir=os.path.join(benchmark_dir, "academic-advising-2014")
...
ACADEMIC_ADVISING_2018 = [
    Problem("academic-advising-2018", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "academic-advising-2018")
...
CHROMATIC_DICE_2018 = [
    Problem("chromatic-dice-2018", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "chromatic-dice-2018")
    ) for inst, min_reward in zip(range(1,21), min_rewards)
]
...
COOPERATIVE_RECON_2018 = [
    Problem("cooperative-recon-2018", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "cooperative-recon-2018")
    ) for inst, min_reward in zip(range(1,21), min_rewards)
]
...
CROSSING_TRAFFIC_2011 = [
    Problem("crossing-traffic-2011", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "crossing-traffic-2011")
...
EARTH_OBSERVATION_2018 = [
    Problem("earth-observation-2018", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "earth-observation-2018")
    ) for inst, min_reward in zip(range(1,21), min_rewards)
]
...
ELEVATORS_2011 = [
    Problem("elevators-2011", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "elevators-2011")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
GAME_OF_LIFE_2011 = [
    Problem("game-of-life-2011", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "game-of-life-2011")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
MANUFACTURER_2018 = [
    Problem("manufacturer-2018", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "manufacturer-2018")
    ) for inst, min_reward in zip(range(1,21), min_rewards)
]
...
NAVIGATION_2011 = [
    Problem("navigation-2011", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "navigation-2011")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
PUSH_YOUR_LUCK_2018 = [
    Problem("push-your-luck-2018", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "push-your-luck-2018")
    ) for inst, min_reward in zip(range(1,21), min_rewards)
]

RECON_2011 = [
    Problem("recon-2011", inst, 0.0,
            benchmarks_dir=os.path.join(benchmark_dir, "recon-2011")
    ) for inst in range(1,11)
]
...
RED_FINNED_BLUE_EYE_2018 = [
    Problem("red-finned-blue-eye-2018", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "red-finned-blue-eye-2018")
    ) for inst, min_reward in zip(range(1,21), min_rewards)
]
...
SKILL_TEACHING_2011 = [
    Problem("skill-teaching-2011", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "skill-teaching-2011")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
SYSADMIN_2011 = [
    Problem("sysadmin-2011", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "sysadmin-2011")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
TAMARISK_2014 = [
    Problem("tamarisk-2014", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "tamarisk-2014")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
TRAFFIC_2011 = [
    Problem("traffic-2011", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "traffic-2011")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
TRIANGLE_TIREWORLD_2014 = [
    Problem("triangle-tireworld-2014", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "triangle-tireworld-2014")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
WILDFIRE_2014 = [
    Problem("wildfire-2014", inst, min_reward,
            benchmarks_dir=os.path.join(benchmark_dir, "wildfire-2014")
    ) for inst, min_reward in zip(range(1,11), min_rewards)
]
...
WILDLIFE_PRESERVE_2018 = [
    Problem("wildlife-preserve-2018", inst, min_reward,
            domain_file=os.path.join(benchmark_dir,
                                     "wildlife-preserve-2018",
                                     "wildlife-preserve_{:02d}_mdp.rddl".format(inst)),
            problem_file=os.path.join(benchmark_dir,
                                      "wildlife-preserve-2018",
